...
public class FileUtil {
    ...
    public final static String SAVE_FILE_PATH_DIRECTORY = SDCARD_PATH + "/"+ "imengququ";//文件保存目录
    public final static String EXTERNAL_SDCARD_PATH = SDCARD_PATH+ "/external_sd";
//    public final static String EXTERNAL_321BROWSER_PATH = EXTERNAL_SDCARD_PATH+ "/imengququ";
...
//    public final static String LIVEMEDIA_PATH = SAVE_FILE_PATH_DIRECTORY+ CacheUtils.liveBasePath;
    ...
    public final static String CACHE_IMAGES_PATH = "/imengququ" + CACHE_IMG_DIR_PATH;
...
//    public final static String PLAT_BOUND_CACHE_PATH = FileUtil.SAVE_FILE_PATH_DIRECTORY+CacheUtils.plat_login_path+"platbound";
    ...
    private static final String LOG_PATH = SAVE_FILE_PATH_DIRECTORY+ "/log.txt";
