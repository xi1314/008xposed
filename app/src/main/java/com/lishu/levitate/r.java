...
final class r
  implements Runnable
{
  r(p paramp, String paramString, boolean paramBoolean) {}
      ...
      try
      {
        ...
        if (!SetNetAddressActivity.b())
        {
          ...
          if (((String)localObject1).length() > 10)
          {
            ...
            str1 = LoadActivity.getImei(a.b(this.a.a), LoadActivity.a, LoadActivity.b, str1);
        ...
        else
        {
          ...
          Toast.makeText(a.b(this.a.a), "从自定义网络数据接口获取数据成功", 0).show();
          return;
        }
 ...
 * Qualified Name:     com.lishu.levitate.r
