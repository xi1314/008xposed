  ...
  extends Activity
{
  ...
  ArrayList b;
  View.OnClickListener c = new ez(this);
  boolean d = false;
  ...
  public final void a()
  {
    ...
    for (;;)
    {
      ...
      {
        PoseHelper008.saveDataToFile("UnInstallWhiteActivity", maputils.creatmap(localHashMap));
        return;
      }
 ...
 * Qualified Name:     com.soft.tools.UnInstallWhiteActivity
