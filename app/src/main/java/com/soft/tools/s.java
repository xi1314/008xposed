...
{
  s(ClearApplicationDataActivity paramClearApplicationDataActivity) {}
  
  public final void onClick(View paramView)
  {
    if (ClearApplicationDataActivity.a(this.a).equals(paramView))
    {
    ...
    do
    {
      for (;;)
      {
        ...
        if (!ClearApplicationDataActivity.b(this.a).equals(paramView)) {
          break label161;
        }
        paramView = this.a.a.entrySet().iterator();
    ...
    } while (!ClearApplicationDataActivity.c(this.a).equals(paramView));
    new t(this).start();
  }
}
 ...
 * Qualified Name:     com.soft.tools.s
